...
import {SharingOperationPartialDTO, SharingOperationPartialQuery} from '../../../../shared/dtos/sharing_operation.dtos';
...
export class SharingOperationsList implements OnInit {
  ...
  constructor(
    private sharingOperationsService: SharingOperationService,
  ...
  onAddSharingOperation() {
    ...
    if(this.ref){
      this.ref.onClose.subscribe((result) => {
        if (result) {
          this.snackbarNotification.openSnackBar(this.translate.instant('SHARING_OPERATION.LIST.SHARING_OPERATION_ADDED_SUCCESSFULLY_LABEL'), VALIDATION_TYPE);
